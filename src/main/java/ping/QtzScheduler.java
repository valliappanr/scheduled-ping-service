...
public class QtzScheduler {
    ...
    public Scheduler scheduler(Trigger trigger, JobDetail job)
        ...
        //factory.initialize(applicationContext.getResource("classpath:quartz.properties").getInputStream());
    ...
    public JobDetail jobDetail() {
        ...
        return newJob().ofType(PingJob.class).storeDurably()
